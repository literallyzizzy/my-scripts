...
if not Success then
	warn("\nRay Hub - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if RayHub.Flags[a] then
			...
			warn("Ray Hub Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function RayHub:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Ray Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Ray Hub"
